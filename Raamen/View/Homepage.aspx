<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Homepage.aspx.cs" Inherits="Raamen.View.Homepage" %>
...
<body>
    <form id="form1" runat="server">
        <div class="container">
            ...
            <img src="ramen_nobg.png" alt="Ramen plain" class="store-image" />
