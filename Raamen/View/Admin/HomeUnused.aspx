<%@ Page Language="C#" MasterPageFile="~/View/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="HomeUnused.aspx.cs" Inherits="Raamen.View.Adminhome" %>
...
<body style="background-color: #ECE8E7;">
    <form id="form1" runat="server">
        <div class="navbar">
            <div class="logo">
                <img src="View/assets/ramen_nobg.png" alt="Company Logo" class="company-logo" />
            </div>
